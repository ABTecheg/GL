...
{
    public partial class ClearanceCompanies : Form
    {
        public ClearanceCompanies()
        {
            InitializeComponent();
        }
        ...
        private void ClearanceCompanies_Load(object sender, EventArgs e)
        {
            ...
            adapter = new SqlDataAdapter("Select * from ClearanceCompanies", sqlcon);
            cmdBuilder = new SqlCommandBuilder(adapter);
            adapter.Fill(dbAccountingProjectDS.ClearanceCompanies);
            dgv.DataSource = dbAccountingProjectDS.ClearanceCompanies;
        ...
        {
            adapter.Update(dbAccountingProjectDS.ClearanceCompanies);
            dbAccountingProjectDS.ClearanceCompanies.AcceptChanges();
        }
        ...
        private void btnSavenew_Click(object sender, EventArgs e)
        {
                ...
                && GeneralFunctions.ValidateString(txtName1.Text, "Please Specify Name1"))
            {
                ...
                DataRow r = dbAccountingProjectDS.ClearanceCompanies.NewRow();
                r["Code"] = txtCode.Text;
                ...
                if (chkactive.Checked == true)
                    ...
                    r["Active"] = "I";
                dbAccountingProjectDS.ClearanceCompanies.Rows.Add(r);
                sqlcon.Close();
                ClearAll();
            }
        ...
        private void Btnsaveedit_Click(object sender, EventArgs e)
        {
            if (dgv.SelectedRows.Count > 0)
            {
               ...
               && GeneralFunctions.ValidateString(txtName1.Text, "Please Specify Name1"))
                {
                    DataRow[] rArr = dbAccountingProjectDS.ClearanceCompanies.Select("Code = '" + txtCode.Text + "'");
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                dbAccountingProjectDS.ClearanceCompanies.Rows[dgv.SelectedRows[0].Index].Delete();
                ClearAll();
            }
            else
            {
        ...
        private void btn_New_Click(object sender, EventArgs e)
        {
            ...
            sqlconBatch.Open();
            SqlCommand getBatch = new SqlCommand("Select Max(Code)+1 From ClearanceCompanies", sqlconBatch);
        ...
        private void dgv_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                DataRow r = dbAccountingProjectDS.ClearanceCompanies.Rows[dgv.SelectedRows[0].Index];
