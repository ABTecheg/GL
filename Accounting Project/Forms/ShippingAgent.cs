...
{
    public partial class ShippingAgent : Form
    {
        ...
        private void ShippingAgent_Load(object sender, EventArgs e)
        {
            ...
            adapter = new SqlDataAdapter("Select * from ShippingAgent", sqlcon);
            cmdBuilder = new SqlCommandBuilder(adapter);
            adapter.Fill(dbAccountingProjectDS.ShippingAgent);
            dgv.DataSource = dbAccountingProjectDS.ShippingAgent;
        ...
        {
            adapter.Update(dbAccountingProjectDS.ShippingAgent);
            dbAccountingProjectDS.ShippingAgent.AcceptChanges();
        }
        ...
        private void btnSavenew_Click(object sender, EventArgs e)
        {
                ...
                && GeneralFunctions.ValidateString(txtName1.Text, "Please Specify Name1"))
            {
                ...
                DataRow r = dbAccountingProjectDS.ShippingAgent.NewRow();
                r["Code"] = txtCode.Text;
                ...
                if (chkactive.Checked == true)
                    ...
                    r["Active"] = "I";
                dbAccountingProjectDS.ShippingAgent.Rows.Add(r);
                sqlcon.Close();
                ClearAll();
            }
        ...
        private void Btnsaveedit_Click(object sender, EventArgs e)
        {
            if (dgv.SelectedRows.Count > 0)
            {
               ...
               && GeneralFunctions.ValidateString(txtName1.Text, "Please Specify Name1"))
                {
                    DataRow[] rArr = dbAccountingProjectDS.ShippingAgent.Select("Code = '" + txtCode.Text + "'");
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                dbAccountingProjectDS.ShippingAgent.Rows[dgv.SelectedRows[0].Index].Delete();
                ClearAll();
            }
            else
            {
        ...
        private void btn_New_Click(object sender, EventArgs e)
        {
            ...
            sqlconBatch.Open();
            SqlCommand getBatch = new SqlCommand("Select Max(Code)+1 From ShippingAgent", sqlconBatch);
        ...
        private void dgv_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgv.SelectedRows.Count > 0)
            {
                DataRow r = dbAccountingProjectDS.ShippingAgent.Rows[dgv.SelectedRows[0].Index];
