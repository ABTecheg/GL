...
namespace Accounting_GeneralLedger.Report {
    ...
    public class IncomeMenu : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Accounting_GeneralLedger.Report.IncomeMenu.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedIncomeMenu : Component, ICachedReport {
        
        public CachedIncomeMenu() {
        }
