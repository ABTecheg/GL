...
namespace Accounting_GeneralLedger.Report {
    ...
    public class RptBSList : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Accounting_GeneralLedger.Report.RptBSList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptBSList : Component, ICachedReport {
        
        public CachedRptBSList() {
        }
