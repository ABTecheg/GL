...
{
    public partial class RptARByTranCode : Form
    {
        public RptARByTranCode()
        {
            InitializeComponent();
        }
        public static short decmial = 0;
        private void RptARByTranCode_Load(object sender, EventArgs e)
        {
            CR_ARTranCode rptARTranCode = new CR_ARTranCode();
            ...
            try
            {
                ...
                rptARTranCode.SetDataSource(dsTrial);

                CrystalDecisions.CrystalReports.Engine.TextObject txtFrom;
                CrystalDecisions.CrystalReports.Engine.TextObject txtTo;


                txtFrom = (CrystalDecisions.CrystalReports.Engine.TextObject)rptARTranCode.ReportDefinition.ReportObjects["txtFrom"];
                txtFrom.Text = RptARTranBatch.txtFrom;

                txtTo = (CrystalDecisions.CrystalReports.Engine.TextObject)rptARTranCode.ReportDefinition.ReportObjects["txtTo"];
                ...
                AmountLC1 = (CrystalDecisions.CrystalReports.Engine.FieldObject)rptARTranCode.ReportDefinition.ReportObjects["AmountLC1"];
                SumofAmountLC1 = (CrystalDecisions.CrystalReports.Engine.FieldObject)rptARTranCode.ReportDefinition.ReportObjects["SumofAmountLC1"];
                SumofAmountLC2 = (CrystalDecisions.CrystalReports.Engine.FieldObject)rptARTranCode.ReportDefinition.ReportObjects["SumofAmountLC2"];
                ...
                this.crystalReportViewer1.ReportSource = rptARTranCode;
