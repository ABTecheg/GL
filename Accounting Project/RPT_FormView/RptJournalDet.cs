...
{
    public partial class RptJournalDet : Form
    {
        public RptJournalDet()
        {
            InitializeComponent();
        }
        public static short decmial = 0;
        private void RptJournalDet_Load(object sender, EventArgs e)
        {
            RptJournalDetails rptjnl = new RptJournalDetails();
