...
{
    public partial class RPTAge_O_I_Details : Form
    {
        public RPTAge_O_I_Details()
        {
            InitializeComponent();
        }
        public static DateTime DateAge;
        public static short decmial = 0;
        private void RPTAge_O_I_Details_Load(object sender, EventArgs e)
        {
            RPTAge_O_I_Det rptAgeOpenItem = new RPTAge_O_I_Det();
            ...
            try
            {
                ...
                Bal5st1 = (CrystalDecisions.CrystalReports.Engine.FieldObject)rptAgeOpenItem.ReportDefinition.ReportObjects["Bal5st1"];
